...
import { AppVersionMLRoutingModule } from './appversionml.routing';
...
@NgModule({
  declarations: [ListAppVersionMLComponent, ModalAppVersionMLComponent],
  imports: [
    CommonModule,
    TableModule,
    CalendarModule,
...
export class AppVersionMLModule {}
