...
public final class SecurityUtils {
    ...
    public static Stream<String> getAuthorities(Authentication authentication) {
    	Map<String, Object> claims = ((JwtAuthenticationToken) authentication).getToken().getClaimAsMap("realm_access");
    	Collection<? extends GrantedAuthority> authorities = extractAuthorityFromClaims(claims);
